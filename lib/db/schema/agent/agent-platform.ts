...
export const agentPlatforms = pgTable(
  'agent_platforms',
  {
...
export const agentPlatformMappings = pgTable(
  ...
  (t) => ({
    agentPlatformMappingUq: uniqueIndex('agent_platform_mappings_agent_platform_uq').on(
      t.agentId,
      t.platformId
    ),
  })
