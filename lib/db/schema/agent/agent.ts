...
export const agents = pgTable(
  'agents',
  {
    ...
    commissionPer: numeric('commission_per', { precision: 5, scale: 2 }).notNull().default('0.00'),
    inviteCode: text('invite_code').notNull().unique(),
    onlineBalance: numeric('online_balance', { precision: 12, scale: 2 }).notNull().default('0.00'),
