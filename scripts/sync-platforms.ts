...
async function main() {
  ...
  console.log(
    `✓ synced: ${result.updated} updated, ${result.inserted} inserted, ${result.total} total`
  );
  console.log(
    `  (${result.unmatchedExisting} pre-seeded rows had no API match and were left untouched)`
  );
