...
import { Wallet, Coins, Copy, Mail, Check } from 'lucide-react';
...
export function WalletOverview({ data, mutate, flash }: Props) {
      ...
      <Card>
        ...
        <div className="mt-5 space-y-2 text-sm">
          <p className="flex flex-wrap items-center gap-2">
            ...
            <Btn className="px-3 py-1 text-xs" onClick={() => setEmailModalOpen(true)}>
              Change Email
            </Btn>
          </p>
          <p className="flex flex-wrap items-center gap-2">
