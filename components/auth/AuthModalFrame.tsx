  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center sm:p-4">
      ...
      <div className="relative z-10 flex max-h-[92dvh] w-full max-w-[950px] animate-modalScaleIn overflow-hidden rounded-t-2xl bg-[var(--modal-bg)] shadow-2xl sm:max-h-[90dvh] sm:rounded-2xl">
        <div className="relative hidden w-[380px] shrink-0 flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-brand-solid to-emerald-900 p-10 text-center md:flex">
          ...
          <p className="relative mt-5 text-2xl font-black text-white">Digit Link</p>
